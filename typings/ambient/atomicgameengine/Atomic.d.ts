...
//----------------------------------------------------
   ...
   export class Texture2D extends Texture {
      ...
      /**  Autoresolve true means the multisampled texture will be automatically resolved to 1-sample after being rendered to and before being sampled as a texture.
         ...
         */
      setSize(width: number, height: number, format: number, usage?: TextureUsage, multiSample?: number, autoResolve?: boolean): boolean;
   ...
   export class TextureCube extends Texture {
      ...
      setSize(size: number, format: number, usage?: TextureUsage, multiSample?: number): boolean;
